...
import com.trainings_notebook.backend.domain.NotificationEmail;
...
import com.trainings_notebook.backend.repositories.VerificationTokenRepository;
import com.trainings_notebook.backend.security.JwtProvider;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please Activate your Account",
                user.getEmail(), "Thank you for signing up to Trainings Notebook, " +
    ...
    public void verifyAccount(String token) {
        ...
        fetchUserAndEnable(verificationToken.orElseThrow(() -> new SpringNotebookException("Invalid token")));
    }

    private void fetchUserAndEnable(VerificationToken verificationToken) {
        String username = verificationToken.getUser().getUsername();
        User user = userRepository.findByUsername(username).orElseThrow(() -> new SpringNotebookException("User not found with name - " + username));
